    ...
    <main ref={rootRef} className="min-h-dvh pb-28 max-w-md mx-auto px-4">
      ...
      {error && (
        <div className="text-center py-24">
          ...
          <button onClick={refresh} className="text-sm text-emerald-500 mt-2 hover:underline">Retry</button>
        </div>
      )}
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="w-11 h-11 rounded-lg flex items-center justify-center text-zinc-500 hover:text-red-300 hover:bg-red-500/10 transition-all"
                    >
                      {deletingId === entry.id ? (
